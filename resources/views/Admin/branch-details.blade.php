                                        ...
                                        <div class="ms-auth-container row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$Branch->BranchNameEn}}" id="Branch_Name" disabled class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$Branch->BranchAddress}}" id="Branch_Adress" disabled class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$Branch->BranchLocation}}" id="Branch_Location" disabled class="form-control"
