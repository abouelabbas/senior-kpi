                                    ...
                                    <div class="row">
                                        <div class=" form-group col-md-6">
                                            ...
                                            <input type="hidden" name="StudentId" value="{{$Student->StudentId}}" />
                                               <input type="text" value="{{$Student->FullnameEn}}" name="FullnameEn" class="form-control" id="student_EN_Name" placeholder="student EN name">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student AR Name</label>
                                            <div class="input-group">
                                               <input type="text" value="{{$Student->FullnameAr}}" name="FullnameAr" class="form-control" id="student_AR_Name" placeholder="student AR name">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student Password</label>
                                            <div class="input-group">
                                               <input type="password" value="{{$Student->Password}}" name="Password" class="form-control" id="student_PR_mobile" placeholder="Student mobile">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                          <label  >Student Mobile</label>
                                          <div class="input-group">
                                             <input type="text" name="Phone" value="{{$Student->Phone}}" class="form-control" id="student_PR_mobile" placeholder="Student mobile">
                                          </div>
                                      </div>
                                        <div class=" form-group col-md-6">
                                  ...
                                  <div class="input-group">
                                     ...
                                     <input type="text" name="PersonalEmail" value="{{$Student->PersonalEmail}}" class="form-control" id="student_Whatsapp" placeholder="Student Personal Email">
                                        ...
                                        <div class=" form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                               <input type="text" name="Facebook" value="{{$Student->Facebook}}" class="form-control" id="student_FB_Account" placeholder="Student FB Account">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student DOB</label>
                                            <div class="input-group">
                                               <input type="date" name="Birthdate" value="{{$Student->Birthdate}}" class="form-control" id="student_DOB" placeholder="Student DOB">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student Adderss</label>
                                            <div class="input-group">
                                               <input type="text" name="Address" value="{{$Student->Address}}" class="form-control" id="student_Adderss" placeholder="Student Adderss">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student Education</label>
                                            <div class="input-group">
                                               <input type="text" name="Education"  value="{{$Student->Education}}" class="form-control" id="student_Education" placeholder="Student Education">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student University</label>
                                            <div class="input-group">
                                               <input type="text" name="University"  value="{{$Student->University}}"  class="form-control" id="student_University" placeholder="Student University">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student Faculty</label>
                                            <div class="input-group">
                                               <input type="text" name="Faculty" value="{{$Student->Faculty}}"  class="form-control" id="student_Faculty" placeholder="Student Faculty">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label  >Student Nationality</label>
                                            <div class="input-group">
                                               <input type="text" name="Nationality" value="{{$Student->Nationality}}"  class="form-control" id="student_Nationality" placeholder="Student Nationality">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label>Student Job</label>
                                            <div class="input-group">
                                               <input type="text" name="Job" value="{{$Student->Job}}"  class="form-control" id="student_JOB" placeholder="Student JOB">
                                            </div>
                                        </div>
                                        <div class=" form-group col-md-6">
                                            <label>Student Company</label>
                                            <div class="input-group">
                                               <input type="text" name="Company" value="{{$Student->Company}}"  class="form-control" id="student_Company" placeholder="Student Company">
                                            </div>
                                        </div>
                                        {{-- <div class=" form-group col-md-6">
                                            ...
                                            {{-- <div class="input-group"> --}}
                                                    {{-- <div class="input-group"> --}}
                                                            <div class="input-group mb-3">
                                                              ...
                                                              <input type="file" name="ImagePath" value="{{$Student->ImagePath}}" id="inputGroupFile03 student_img" class="custom-file-input">
                                                              {{-- <input type="file" /> --}}
                                        ...
                                        <div class=" form-group col-md-12">
                                            <label  >note</label>
                                            <div class="input-group">
                                               <textarea id="trainer_note" name="AdditionalNotes" class="form-control" placeholder="Note" rows="4">{{$Student->AdditionalNotes}}</textarea>
                                            </div>
                                        </div>
                                  </div>
