...
@section('content')
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="/Admin/Course/{{$Round->RoundId}}">{{$Course->CourseNameEn}} - {{$Round->GroupNo}} - Session #{{$Session->SessionNumber}}</a></li>
