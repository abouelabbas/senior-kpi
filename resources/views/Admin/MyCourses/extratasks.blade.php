...
@section('content')
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="/Admin/Courses/{{$Round->RoundId}}">{{$Course->CourseNameEn}} - {{$Round->GroupNo}} - Session #{{$Session->SessionNumber}}</a></li>
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <div class="d-flex justify-content-end">
                <a href="{{url("/Admin/ExtraTask/$Round->RoundId/Add/$Session->SessionId")}}" class="btn btn-success mb-2 mt-0">Add Extra Task</a>&nbsp;
...
{{-- 
                        ...
                        <td>
                          ...
                          <div class="p-1 d-inline-block">
                            <a href="{{url("/Admin/ExtraTask/$Task->ExtraTaskId/Edit")}}" class="btn btn-info">
                          <i class="far fa-edit"></i>
                          </a>
                          </div>
                          <div class="p-1 d-inline-block">
                            <a href="{{url("/Admin/ExtraTask/$Task->ExtraTaskId/Delete")}}" class="btn btn-danger">
