          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <div class="d-flex justify-content-end">
                <a href="{{url("/Admin/Content/$Round->RoundId/Add")}}" class="btn btn-success mb-2 mt-0">Add Extra Content</a>&nbsp;
                  ...
                  <tbody>
                    ...
                    @endphp
                      ...
                      @foreach ($Content as $Cont)
                        ...
                        <td>
                          <a href="{{$Cont->ContentURL}}" class="btn btn-square btn-outline-primary has-icon" target="_blank">
                        ...
                        <td>
                          ...
                          <div class="p-1 d-inline-block">
                            <a href="{{url("/Admin/Content/$Cont->ContentId/Edit")}}" class="btn btn-info">
                          <i class="far fa-edit"></i>
                          </a>
                          </div>
                          <div class="p-1 d-inline-block">
                            <a href="{{url("/Admin/Content/$Cont->ContentId/Delete")}}" class="btn btn-danger">
