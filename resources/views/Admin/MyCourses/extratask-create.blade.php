...
@section('content')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/Admin/Branches"> {{$Course->CourseNameEn}} - G{{$Round->GroupNo}} - Session #{{$Session->SessionNumber}}</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                                <form action="/Admin/ExtraTask/Create" method="POST">
{{ csrf_field() }}
