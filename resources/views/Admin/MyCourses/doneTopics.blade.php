...
@section('content')
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/Admin/Courses/{{$Round->RoundId}}">{{$Course->CourseNameEn}} - GR{{$Round->GroupNo}}</a></li>
          ...
          <div class="modal-body">
            ...
            <div class="ms-auth-container row no-gutters">
                <div class="col-12 p-5">
                    <form action="/Admin/DoneTopics/Add/{{$Topicname->RoundId}}" method="POST">
                      {{ csrf_field() }}
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ms-auth-container row no-gutters">
            <div class="col-12 p-5">
                <form action="/Admin/DoneTopics/Example/{{$Topicname->RoundId}}" method="POST">
                  {{ csrf_field() }}
                <label for="note">Topic Name</label>
                <div class="input-group">
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ms-auth-container row no-gutters">
            <div class="col-12 p-5">
                <form action="/Admin/DoneTopics/Task/{{$Topicname->RoundId}}" method="POST">
                  {{ csrf_field() }}
                <label for="note">Topic Name</label>
                <div class="input-group">
                   <select name="SubContentId" id=""  class="form-control">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="ms-auth-container row no-gutters">
                <div class="col-12 p-5">
                    <div class="d-flex justify-content-end">
                        <a href="/Admin/Course/DoneTopics/Delete/{{$TopicSub->RoundSubContentsId}}/{{$TopicSub->RoundSubContentsId}}/{{$TopicContent->RoundId}}" class="btn btn-danger"> <i class="fas fa-trash"></i> </a>
                    </div>
                    <form action="/Admin/DoneTopics/Edit/{{$Topicname->RoundId}}" method="POST">
                      {{ csrf_field() }}
                      
                      <input type="hidden" name="RoundSubContentsId" value="{{$TopicSub->RoundSubContentsId}}" />
                      <input type="hidden" name="TrainerSubAgendaId" value="{{$TopicSub->RoundSubContentsId}}" />
