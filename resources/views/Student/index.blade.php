@extends('Layouts/studentkpi',['Notifications'=>$Notifications,'CountNotifications'=>$CountNotifications,'StudentRounds'=>$StudentRounds])
@section('content')
<div class="row">
                ...
                <div class="ms-card card-gradient-success ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                        <div class="media-body">
                            ...
                            {{-- <p class="ms-card-change"> <i class="material-icons">arrow_upward</i> </p>{{$Trainers}} --}}
                            <p class="fs-12">All trainers trying their best.</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="ms-card card-gradient-secondary ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                        <div class="media-body">
                            <h6>Rounds</h6>
                            {{-- <p class="ms-card-change"> </p> {{$Rounds}}{{$Running}} --}}
                            <p class="fs-12">Our courses are running now</p>
                ...
                <div class="ms-card card-gradient-warning ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                        <div class="media-body">
                            ...
                            {{-- <p class="ms-card-change"> <i class="material-icons">arrow_upward</i> </p>{{$Students}} --}}
                            <p class="fs-12">Our Students are attending these rounds</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="ms-card card-gradient-info ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                        <div class="media-body">
                            <h6>Branches</h6>
                        {{-- <p class="ms-card-change"> </p>{{$Branches}}{{$Labs}} --}}
                        <p class="fs-12">Our branches and labs are fully supported</p>
                        </div>
                    </div>
