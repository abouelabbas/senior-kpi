...
<div class="ms-panel ms-panel-fh">
  ...
  <form action="/Student/Profile/Edit" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
  ...
  {{ csrf_field() }}
        ...
        <div class="form-row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="Birthdate" value="{{$Student->Birthdate}}" class="form-control" data-toggle="datepicker" id="birthdate" placeholder="Birth Date" aria-describedby="birthdate">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="Job" value="{{$Student->Job}}" class="form-control" id="Job" placeholder="Job"  >
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="Company" value="{{$Student->Company}}" class="form-control" id="Company" placeholder="Company" >
        ...
        <div class="col-md-6 mb-3">
            ...
            <label for="ImagePath">Photo</label>
              ...
              <input type="file" name="ImagePath" value="{{$Student->ImagePath}}" class="form-control" id="ImagePath" placeholder="ImagePath" >

                <div class="invalid-feedback">
Please enter student photo
