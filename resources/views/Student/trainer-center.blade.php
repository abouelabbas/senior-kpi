                    ...
                    <form id="fform" action="">
                      ...
                      <td>
                        ...
                        <?php
                          ...
                          $totaltrainer = (($SeniorEval->Students_Deal + $SeniorEval->Solving_Problems + $SeniorEval->Buffet_Quality + $SeniorEval->General_Cleanliness + $SeniorEval->Recepitionist_Quality + $SeniorEval->Answering_Calls_Quality +  $SeniorEval->Social_Media_Quality + $SeniorEval->Overall_Evaluation)/40)*100 ;
...
@endforeach
          ...
          <div class="ms-panel">
              ...
              <h6>Trainer Evaluation per Track</h6>
                      ...
                      <td>
                        ...
                        <td><?php
                          ...
                          ?>
                            ...
                            data-value="@if ($totalcenter !== 0){{number_format($totalcenter,0)}}@else 0 @endif"
