        ...
        <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
            ...
            @foreach ($TrainerRounds as $TrainerRound)
              ...
              <ul id="basic-elements" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
                ...
                <li> <a href="/Trainer/Evaluations/{{$TrainerRound->RoundId}}">My Evaluation</a> </li>

                <li> <a href="/Trainer/CenterEvaluation/{{$TrainerRound->RoundId}}">Senior Steps Eval</a> </li>
...
@foreach ($Notifications as $Notification)
        ...
        <a href="{{$Notification->NotificationLink}}" class="media p-2">
