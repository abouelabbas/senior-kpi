...
<body class="ms-body   ms-primary-theme ms-has-quickbar">
    ...
    <a href="#" class="has-chevron collapsed" data-toggle="collapse" data-target="#course-detils{{$StudentRound->RoundId}}" aria-expanded="false" aria-controls="authentication">{{$StudentRound->CourseNameEn}} G{{$StudentRound->GroupNo}}</a>

    <ul id="course-detils{{$StudentRound->RoundId}}" class="collapse" aria-labelledby="course-detils" data-parent="#basic-elements">

    <li> <a href="/Student/Course/{{$StudentRound->RoundId}}">Course Progress</a> </li>
        ...
        <nav class="navbar ms-navbar">
            ...
            <div class="logo-sn logo-sm ms-d-block-sm">
                ...
                <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img
                        ...
                        src="{{ asset('img/logo-sm-dark.png') }}" alt="logo"> </a>
            ...
            <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
                ...
                <li class="ms-nav-item dropdown">
                    ...
                    <a href="#" class="text-disabled ms-has-notification" id="notificationDropdown" data-type="Student" data-id="{{session('Id')}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
@endif
                  ...
                  <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                    ...
                    <li class="ms-dropdown-list">
                      ...
                      <a class="media fs-14 p-2" href="/Student/Profile"> <span><i class="flaticon-user mr-2"></i> Profile</span> </a>
