  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
          ...
          <span><i class="material-icons fs-16">filter_list</i>Running Courses</span>
          ...
          <ul id="basic-elements" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
            ...
            <li class="menu-item">
              ...
              <li> <a href="/Admin/Evaluations/{{$Round->RoundId}}">Trainer / Course Eval</a> </li>
  
              <li> <a href="/Admin/CenterEvaluation/{{$Round->RoundId}}">Senior Steps Eval</a> </li>
    ...
    <!--  Course  -->
          ...
          <li class="menu-item">
            ...
            <a href="#" class="has-chevron" data-toggle="collapse" data-target="#basic-elements1" aria-expanded="false" aria-controls="basic-elements">
  
            <span><i class="material-icons fs-16">filter_list</i>History Courses</span>
  
          </a>
  
            <ul id="basic-elements1" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
  
              @foreach ($ActiveRounds as $RoundH)
  
              @if ($RoundH->Done == 0)
              <li class="menu-item">
  
                <a href="#" class="has-chevron collapsed" data-toggle="collapse" data-target="#course-detils{{$RoundH->RoundId}}" aria-expanded="false" aria-controls="authentication">{{$RoundH->CourseNameEn}} GR {{$RoundH->GroupNo}}</a>
    
                <ul id="course-detils{{$RoundH->RoundId}}" class="collapse" aria-labelledby="course-detils" data-parent="#basic-elements">
    
                <li> <a href="/Admin/Courses/{{$RoundH->RoundId}}">Course Progress</a> </li>
    
                <li> <a href="/Admin/Evaluations/{{$RoundH->RoundId}}">Evaluations</a> </li>
    
                <li> <a href="/Admin/CenterEvaluation/{{$RoundH->RoundId}}">Trainer-Center Eval</a> </li>
