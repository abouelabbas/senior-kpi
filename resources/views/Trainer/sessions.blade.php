...
{{-- @extends('Layouts.Trainerkpi',['ActiveRounds'=>$ActiveRounds])
        ...
        @endphp
          ...
          @foreach ($Sessions as $Session)
            ...
            <a href="#" class="btn btn-square btn-outline-success has-icon" data-toggle="modal" data-target="#MaterialModal{{$Session->SessionId}}" >
              ...
              @if ($Session->SessionMaterial !== null || $Session->MaterialText !== null)
              {{-- <a href="{{$Session->SessionMaterial}}" target="_blank" class="btn btn-square btn-outline-success has-icon" >
...
@endif
            ...
            <a href="#" class="btn btn-square btn-outline-primary has-icon" data-toggle="modal" data-target="#TaskModal{{$Session->SessionId}}" >
              ...
              @endif
                        ...
                        <td>
                            <a href='{{url("Trainer/Round/$Round->RoundId/ExtraTasks/$Session->SessionId")}}' class="btn btn-square btn-outline-primary has-icon" >
...
<div class="modal-body">
  ...
  <form action="/Trainer/Session/ContentUpload" method="POST" enctype="multipart/form-data">
