                              ...
                              @endphp
                                ...
                                <td>{{$i}}</td>
                                                   ...
                                                   <form action="">
                                                     ...
                                                     <input type="text" value="{{$Grade->QuizGrade}}" name="quiz1-grade" data-id="{{$Grade->TaskId}}" placeholder="100%" class="quiz form-control">

                                                     </td>

                                                     <td>

                                                     <input type="text" value="{{$Grade->TaskGrade}}" name="task1-grade" data-status="update" data-grade="{{$Grade->GradeId}}" placeholder="100%" class="task form-control">
