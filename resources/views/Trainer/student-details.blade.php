                  ...
                  <div class="table-responsive">
                    ...
                    <table id="StudentTable" class="dattable table table-striped thead-dark  w-100">
                      ...
                      @foreach ($Attendance as $Session)
                          ...
                          <td><span style="display:none;">{{$Session->SessionId}}</span>{{$i}}</td>
            ...
            <div class="row no-gutters">
                    ...
                    <div>
                      ...
                      <ul>
                        ...
                        <li style="color:red;"><i class="fas fa-circle    "></i> Total sessions cancelled = {{$CountCancelled}} </li>
                              ...
                              @endphp
                                ...
                                <td>{{$i}}</td>
                                                   ...
                                                   <form action="">
                                                     ...
                                                     <input type="text" value="{{$Grade->QuizGrade}}" name="quiz1-grade" data-id="{{$Grade->TaskId}}" placeholder="100%" class="quiz form-control q-changable">

                                                     </td>

                                                     <td>

                                                     <input type="text" value="{{$Grade->TaskGrade}}" name="task1-grade" data-status="update" data-grade="{{$Grade->GradeId}}" placeholder="100%" class="task form-control q-changable">

                                                     </td>

                                                     <td>

                                                     <!-- <a href="/storage/app/public/{{$Grade->TaskURL}}" Download class="ms-btn-icon-outline btn-info">
        ...
        @foreach ($ExamGrades as $ExamGrade)
            ...
            <tr>
                                ...
                                <td>{{$i}}</td>
                                  ...
                                  <span data-toggle="tooltip" data-placement="top" title="{{$ExamGrade->ExamNameEn}}">
                                  ...
                                  <input type="text" data-exam="{{$ExamGrade->ExamGradesId}}" value="{{$ExamGrade->Grade}}" name="quiz1-grade"  placeholder="100%" class="form-control grade-value">
...
<td>{{$i}}</td>
                        ...
                        <td>
                            ...
                            <span data-toggle="tooltip" data-placement="top" title="{{$Evaluation->ContentNameEn}}">
    ...
    <div class="modal-body">
      ...
      <div class="ms-auth-container row no-gutters">
          ...
          <div class="col-12 p-5">
            ...
            <form action="/Trainer/TaskUpload" class="form-prog" id="form-prog" method="POST" enctype="multipart/form-data">
