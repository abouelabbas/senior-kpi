...
@section('content')
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="/Trainer/Course/{{$Round->RoundId}}">{{$Course->CourseNameEn}} - {{$Round->GroupNo}} - Session #{{$Session->SessionNumber}}</a></li>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Submission Grade</label>
                                    <input type="number" class="form-control" value="{{$Task->SubmissionGrade}}" name="SubmissionGrade" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a valid grade %">
                                  </div>

                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Submission Comment</label>
                                    <textarea name="SubmissionComment" class="form-control" placeholder="Enter the Submission Comment" id="" style="resize: auto;">{{$Task->SubmissionComment}}</textarea>
                                  </div>
