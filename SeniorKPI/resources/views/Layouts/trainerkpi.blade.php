...
<head>
  ...
  <link href="{{ asset('css/jquery-ui.min.css') }}" rel="stylesheet">
   <link rel="stylesheet" href="{{ asset('css/FileUpload/demo.css') }}">
   <link rel="stylesheet" href="{{ asset('css/FileUpload/component.css') }}">
...
<body class="ms-body   ms-primary-theme ms-has-quickbar">
    ...
    <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
        ...
        <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
            ...
            {{-- <!-- Dashboard -->
            <li class="menu-item ">
            <a href="/Trainer/Courses/{{session()->get('Id')}}">
                  <span><i class="material-icons fs-16">dashboard</i>My Courses</span>
              </a>
            ...
            @foreach ($TrainerRounds as $TrainerRound)
              <ul id="basic-elements" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
                <li class="menu-item">
                <a href="#" class="has-chevron collapsed" data-toggle="collapse" data-target="#course-detils-{{$TrainerRound->RoundId}}" aria-expanded="false" aria-controls="authentication">{{$TrainerRound->CourseNameEn}} G{{$TrainerRound->GroupNo}}</a>
                <ul id="course-detils-{{$TrainerRound->RoundId}}" class="collapse" aria-labelledby="course-detils" data-parent="#basic-elements">
                <li> <a href="/Trainer/Courses/{{$TrainerRound->RoundId}}">Course Progress</a> </li>
                <li> <a href="/Trainer/Evaluations/{{$TrainerRound->RoundId}}">Attendence & Eval</a> </li>
                <li> <a href="/Trainer/CenterEvaluation/{{$TrainerRound->RoundId}}">Trainer-Center Eval</a> </li>
            ...
            <li class="menu-item">
              <a href="#" class="has-chevron" data-toggle="collapse" data-target="#basic-elements-2" aria-expanded="false" aria-controls="basic-elements">
              <span><i class="material-icons fs-16">filter_list</i>HistoryCourses</span>
            </a>
            @foreach ($HistoryRounds as $HistoryRound)
              <ul id="basic-elements-2" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
                <li class="menu-item">
                <a href="#" class="has-chevron collapsed" data-toggle="collapse" data-target="#course-detils-{{$HistoryRound->RoundId}}" aria-expanded="false" aria-controls="authentication">{{$HistoryRound->CourseNameEn}} G{{$HistoryRound->GroupNo}}</a>
                <ul id="course-detils-{{$HistoryRound->RoundId}}" class="collapse" aria-labelledby="course-detils" data-parent="#basic-elements">
                    <li> <a href="my-Courses.html">Course Progress</a> </li>
                    <li> <a href="Attendence-Evaluations.html">Attendence & Eval</a> </li>
                <li> <a href="/Trainer/CenterEvaluation/{{$HistoryRound->RoundId}}">Trainer-Center Eval</a> </li>
        ...
        <nav class="navbar ms-navbar">
            ...
            <div class="logo-sn logo-sm ms-d-block-sm">
                {{-- <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img
                        src="../assets/img/logo-sm-dark.png" alt="logo"> </a> --}}
            </div>
            ...
            <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
                ...
                <li class="ms-nav-item dropdown">
                    <a href="#" class="text-disabled ms-has-notification" id="notificationDropdown" data-type="Trainer" data-id="{{session('Id')}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          @endforeach
                ...
                <li class="ms-nav-item ms-nav-user dropdown">
                  <a href="#"   id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                      ...
                      <img class="ms-user-img ms-img-round float-left" style="height:35px;width:35px;" src="{{ asset(session('ImagePath')) }}" alt="people"> 

@else
<img class="ms-user-img ms-img-round float-left" src="https://via.placeholder.com/270x270" alt="people"> 

@endif
                    <span class="float-right">{{session()->get('NameEn')}}</span>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                    <li class="dropdown-menu-header">
                    <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, {{session()->get('NameEn')}}</span></h6>
                    </li>
                    <li class="dropdown-divider"></li>
                    <li class="ms-dropdown-list">
                      <a class="media fs-14 p-2" href="/Trainer/Profile"> <span><i class="flaticon-user mr-2"></i> Profile</span> </a>
                    </li>
                    <li class="dropdown-divider"></li>
...
@yield('content')
  ...
  {{-- <script src="{{ asset('js/vueChat.js') }}"></script> --}}
