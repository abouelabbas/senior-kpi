              ...
              <div class="table-responsive">
                <table  class="dattable table table-striped thead-dark  w-100">
                  ...
                  @foreach ($TrainerRounds as $TrainerRound)
                    ...
                    <td>
                    <a href="/Admin/Course/{{$TrainerRound->RoundId}}/Students" class="text-primary">
                        <i class="fas fa-users    "></i> Students
                      </a>
                    </td>
                    <td>
                    <a href="/Admin/Rounds/{{$TrainerRound->RoundId}}/Attendance" class="text-dark">
                        <i class="fas fa-table"></i> Attendence
                      </a>
                    </td>
                    <td>
                      <a href="/Admin/Course/{{$TrainerRound->RoundId}}/Sessions" class="text-success">
                       <i class="fas fa-laptop-code    "></i> Sessions
                      </a>
                    </td>
                    <td>
                      <a href="/Admin/Course/{{$TrainerRound->RoundId}}/DoneTopics" class="text-info">
