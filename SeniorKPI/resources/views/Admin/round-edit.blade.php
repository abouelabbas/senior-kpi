                                                        ...
                                                        <td> 
                                                                ...
                                                                <a href="{{$TrainerRound->Facebook}}" class="ms-btn-icon btn-pill btn-secondary"> <i class="fab fa-facebook-f    "></i> </a>
                                                                  ...
                                                                  @if ($TrainerRound->Youtube)
                                                                      <a href="{{$TrainerRound->Youtube}}" class="ms-btn-icon btn-pill btn-danger"> <i class="fab fa-youtube    "></i> </a>
                                                                  @endif
                                                                  @if ($TrainerRound->Linkedin)
                                                                      <a href="{{$TrainerRound->Linkedin}}" class="ms-btn-icon btn-pill btn-info"> <i class="fab fa-linkedin"></i> </a>
                                                                  @endif
