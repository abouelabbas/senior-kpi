      ...
      <td>{{$i}}</td>
          ...
          <td>
            ...
            <td>
                ...
                data-value="0.{{number_format((($CenterEvaluation->PCs_Quality+$CenterEvaluation->Projectors_Quality+$CenterEvaluation->Air_Conditioners+$CenterEvaluation->Seats_Quality+$CenterEvaluation->Lab_Cleaning+$CenterEvaluation->Lab_Capacity+$CenterEvaluation->Overall_Evaluation)/35)*100)}}"
                data-size="50"
                data-thickness="3"
                ...
                data-reverse="true">
                <div class="percent">
                    {{number_format((($CenterEvaluation->PCs_Quality+$CenterEvaluation->Projectors_Quality+$CenterEvaluation->Air_Conditioners+$CenterEvaluation->Seats_Quality+$CenterEvaluation->Lab_Cleaning+$CenterEvaluation->Lab_Capacity+$CenterEvaluation->Overall_Evaluation)/35)*100)}}%
                </div>
              </div>
            </td>
