...
@section('content')
                ...
                <div class="ms-profile-overview">
                    <div class="ms-profile-cover">
                        ...
                        <h1 class="ms-profile-username">{{$Student->FullnameEn}}</h1>
                            <h2 class="ms-profile-role">{{$Student->Job}}</h2>
                        </div>
    
                    </div>
                    <div class="ms-profile-navigation nav nav-tabs tabs-bordered w-100 d-flex justify-content-end">
                        
                    <a href="/Admin/Students/Edit/{{$Student->StudentId}}" class="btn btn-primary m-2 has-icon"> <i class="flaticon-pencil"
     ...
     --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($Student->Facebook)
                                                    <a href="{{$Student->Facebook}}" class="ms-btn-icon btn-pill btn-secondary"> <i class="fab fa-facebook-f    "></i> </a>
                                                      @endif
                                                      @if ($Student->Youtube)
                                                          <a href="{{$Student->Youtube}}" class="ms-btn-icon btn-pill btn-info"> <i class="fab fa-linkedin    "></i> </a>
                                                      @endif
                                                      @if ($Student->Linkedin)
                                                          <a href="{{$Student->Linkedin}}" class="ms-btn-icon btn-pill btn-danger"> <i class="fab fa-youtube    "></i> </a>
                                                      @endif
                                                </td>
                                            </tr>
